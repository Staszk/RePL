#ifndef REPL_LEXER_HPP
#define REPL_LEXER_HPP
...
/**
 * @brief Levels of warnings that can be generated by the lexer.
 */
...
private:
    ...
    bool IsIdentifierOrKeywordStart();
    ...
    void ConsumeIdentifierOrKeywordToken(Token& arToken);
